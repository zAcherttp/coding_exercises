// ❖ Bài toán: Công ty ABC là công ty sản xuất kinh doanh thú nhồi
// bông. Công ty có nhiều nhân viên làm việc trong ba bộ phận khác
// nhau: bộ phận quản lý, bộ phận sản xuất, bộ phận văn phòng.
// Việc tính lương cho nhân viên dựa vào các yếu tố sau:
// ▪ Đối với nhân viên văn phòng: Lương = Lương Cơ Bản + Số ngày làm
// việc *200.000 + Trợ Cấp
// ▪ Đối với nhân viên sản xuất: Lương = Lương Cơ Bản + Số Sản Phẩm *
// 2.000
// ▪ Đối với nhân viên quản lý: Lương = Lương Cơ Bản* Hệ số chức vụ +
// Thưởng.
