...
int main() {
    ...
    case 3: { // nhap ma tran thu nhat
        ...
        if (a == n && b == m) {
            ...
            for (int i = 0; i < m; i++) {     // dòng của A
                for (int k = 0; k < b; k++) { // cột của B
                    temp = 0;
                    for (int j = 0; j < n; j++) { // cột của A & dòng của B
            ...
            for (int i = 0; i < a; i++) {     // dòng của A
                for (int k = 0; k < n; k++) { // cột của B
                    temp = 0;
                    for (int j = 0; j < b; j++) { // cột của A & dòng của B
